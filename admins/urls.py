...
from admins.views import UserCreateView, UserListView, UserUpdateView, admin_users_remove, index, admin_product_read, admin_product_update, admin_product_remove, admin_product_create
