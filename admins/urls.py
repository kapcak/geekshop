...
from admins.views import admin_users, admin_users_create, admin_users_update, admin_users_remove, index, admin_product_read, admin_product_update, admin_product_remove, admin_product_create
